...
command -v ffmpeg  >/dev/null 2>&1 || error "Missing program, 'ffmpeg'. You need ffmpeg installed."
command -v wget    >/dev/null 2>&1 || error "Missing program, 'wget'. You need wget installed."
